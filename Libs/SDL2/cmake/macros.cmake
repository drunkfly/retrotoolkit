...
macro(DEP_OPTION _NAME _DESC _DEFLT _DEPTEST _FAILDFLT)
  ...
  string(REGEX REPLACE " +" ";" CMAKE_DEPENDENT_OPTION_DEP "${_DEPTEST}")
...
macro(MESSAGE_TESTED_OPTION _NAME)
  ...
  if(NOT "${_REQVALUE_}" STREQUAL "${HAVE_${_NAME}}")
    if(NOT "%${_NAME}" MATCHES "^%(GCC_ATOMICS|ASSEMBLY|SSEMATH|MMX|3DNOW|SSE|SSE2|SSE3|ALTIVEC|SDL_DLOPEN|ARMNEON|ARMSIMD|RPATH)$")
      message_error("'${_NAME}': wanted '${_REQVALUE_}', got '${HAVE_${_NAME}}'")
    endif()
  endif()
endmacro()
