...
Z80_OPCODE_1(AND, byte,             ({ 0xE6, mOp1.value()                           }),  7);
Z80_OPCODE_1(AND, memHL,            ({ 0xA6                                         }),  7);
Z80_OPCODE_1(AND, IX_byte,          ({ 0xDD, 0xA6, mOp1.value()                     }), 19);
Z80_OPCODE_1(AND, IY_byte,          ({ 0xFD, 0xA6, mOp1.value()                     }), 19);
...
Z80_OPCODE_1(CALL, word,            ({ 0xCD, mOp1.low(high), high                   }), 17);
Z80_OPCODE_2(CALL, flagC, word,     ({ 0xDC, mOp2.low(high), high                   }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagM, word,     ({ 0xFC, mOp2.low(high), high                   }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagNC, word,    ({ 0xD4, mOp2.low(high), high                   }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagNZ, word,    ({ 0xC4, mOp2.low(high), high                   }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagP, word,     ({ 0xF4, mOp2.low(high), high                   }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagPE, word,    ({ 0xEC, mOp2.low(high), high                   }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagPO, word,    ({ 0xE4, mOp2.low(high), high                   }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagZ, word,     ({ 0xCC, mOp2.low(high), high                   }), TStates(17, 10));
...
Z80_OPCODE_1(JP, word,              ({ 0xC3, mOp1.low(high), high                   }), 10);
Z80_OPCODE_2(JP, flagC, word,       ({ 0xDA, mOp2.low(high), high                   }), 10);
Z80_OPCODE_2(JP, flagM, word,       ({ 0xFA, mOp2.low(high), high                   }), 10);
Z80_OPCODE_2(JP, flagNC, word,      ({ 0xD2, mOp2.low(high), high                   }), 10);
Z80_OPCODE_2(JP, flagNZ, word,      ({ 0xC2, mOp2.low(high), high                   }), 10);
Z80_OPCODE_2(JP, flagP, word,       ({ 0xF2, mOp2.low(high), high                   }), 10);
Z80_OPCODE_2(JP, flagPE, word,      ({ 0xEA, mOp2.low(high), high                   }), 10);
Z80_OPCODE_2(JP, flagPO, word,      ({ 0xE2, mOp2.low(high), high                   }), 10);
Z80_OPCODE_2(JP, flagZ, word,       ({ 0xCA, mOp2.low(high), high                   }), 10);
Z80_OPCODE_1(JP, memHL,             ({ 0xE9                                         }),  4);
Z80_OPCODE_1(JP, memIX,             ({ 0xDD, 0xE9                                   }),  8);
Z80_OPCODE_1(JP, memIY,             ({ 0xFD, 0xE9                                   }),  8);
Z80_OPCODE_1(JR, relOffset,         ({ 0x18, mOp1.value(nextAddress)                }),  12);
Z80_OPCODE_2(JR, flagC, relOffset,  ({ 0x38, mOp2.value(nextAddress)                }), TStates(12, 7));
...
Z80_OPCODE_2(LD, memHL, byte,       ({ 0x36, mOp2.value()                           }), 10);
...
Z80_OPCODE_2(LD, memAddr, A,        ({ 0x32, mOp1.low(high), high                   }), 13);
Z80_OPCODE_2(LD, memAddr, HL,       ({ 0x22, mOp1.low(high), high                   }), 16);
Z80_OPCODE_2(LD, memAddr, BC,       ({ 0xED, 0x43, mOp1.low(high), high             }), 20);
Z80_OPCODE_2(LD, memAddr, DE,       ({ 0xED, 0x53, mOp1.low(high), high             }), 20);
Z80_OPCODE_2(LD, memAddr, SP,       ({ 0xED, 0x73, mOp1.low(high), high             }), 20);
Z80_OPCODE_2(LD, memAddr, IX,       ({ 0xDD, 0x22, mOp1.low(high), high             }), 20);
Z80_OPCODE_2(LD, memAddr, IY,       ({ 0xFD, 0x22, mOp1.low(high), high             }), 20);
Z80_OPCODE_2(LD, BC, word,          ({ 0x01, mOp2.low(high), high                   }), 10);
Z80_OPCODE_2(LD, DE, word,          ({ 0x11, mOp2.low(high), high                   }), 10);
Z80_OPCODE_2(LD, HL, word,          ({ 0x21, mOp2.low(high), high                   }), 10);
Z80_OPCODE_2(LD, SP, word,          ({ 0x31, mOp2.low(high), high                   }), 10);
Z80_OPCODE_2(LD, BC, memAddr,       ({ 0xED, 0x4B, mOp2.low(high), high             }), 20);
Z80_OPCODE_2(LD, DE, memAddr,       ({ 0xED, 0x5B, mOp2.low(high), high             }), 20);
Z80_OPCODE_2(LD, HL, memAddr,       ({ 0x2A, mOp2.low(high), high                   }), 16);
Z80_OPCODE_2(LD, SP, memAddr,       ({ 0xED, 0x7B, mOp2.low(high), high             }), 20);
...
Z80_OPCODE_2(LD, IX, word,          ({ 0xDD, 0x21, mOp2.low(high), high             }), 14);
Z80_OPCODE_2(LD, IX, memAddr,       ({ 0xDD, 0x2A, mOp2.low(high), high             }), 20);
Z80_OPCODE_2(LD, IY, word,          ({ 0xFD, 0x21, mOp2.low(high), high             }), 14);
Z80_OPCODE_2(LD, IY, memAddr,       ({ 0xFD, 0x2A, mOp2.low(high), high             }), 20);
