...
Z80_OPCODE_2(ADC, A, byte,          ({ 0xCE, mOp2.value()                           }),  7);
...
Z80_OPCODE_2(ADC, A, IX_byte,       ({ 0xDD, 0x8E, mOp2.value()                     }), 19);
Z80_OPCODE_2(ADC, A, IY_byte,       ({ 0xFD, 0x8E, mOp2.value()                     }), 19);
...
Z80_OPCODE_2(ADD, A, byte,          ({ 0xC6, mOp2.value()                           }),  7);
...
Z80_OPCODE_2(ADD, A, IX_byte,       ({ 0xDD, 0x86, mOp2.value()                     }), 19);
Z80_OPCODE_2(ADD, A, IY_byte,       ({ 0xFD, 0x86, mOp2.value()                     }), 19);
...
Z80_OPCODE_1(AND, byte,             ({ 0xE6, mOp2.value()                           }),  7);
Z80_OPCODE_1(AND, memHL,            ({ 0xA6                                         }),  7);
Z80_OPCODE_1(AND, IX_byte,          ({ 0xDD, 0xA6, mOp2.value()                     }), 19);
Z80_OPCODE_1(AND, IY_byte,          ({ 0xFD, 0xA6, mOp2.value()                     }), 19);
...
Z80_OPCODE_2(BIT, bit, memHL,       ({ 0xCB, mOp1.value(0x46)                       }), 12);
Z80_OPCODE_2(BIT, bit, IX_byte,     ({ 0xDD, 0xCB, mOp2.value(), mOp1.value(0x46)   }), 20);
Z80_OPCODE_2(BIT, bit, IY_byte,     ({ 0xFD, 0xCB, mOp2.value(), mOp1.value(0x46)   }), 20);
Z80_OPCODE_2(BIT, bit, A,           ({ 0xCB, mOp1.value(0x47)                       }),  8);
Z80_OPCODE_2(BIT, bit, B,           ({ 0xCB, mOp1.value(0x40)                       }),  8);
Z80_OPCODE_2(BIT, bit, C,           ({ 0xCB, mOp1.value(0x41)                       }),  8);
Z80_OPCODE_2(BIT, bit, D,           ({ 0xCB, mOp1.value(0x42)                       }),  8);
Z80_OPCODE_2(BIT, bit, E,           ({ 0xCB, mOp1.value(0x43)                       }),  8);
Z80_OPCODE_2(BIT, bit, H,           ({ 0xCB, mOp1.value(0x44)                       }),  8);
Z80_OPCODE_2(BIT, bit, L,           ({ 0xCB, mOp1.value(0x45)                       }),  8);
Z80_OPCODE_1(CALL, word,            ({ 0xCD, mOp1.low(), mOp1.high()                }), 17);
Z80_OPCODE_2(CALL, flagC, word,     ({ 0xDC, mOp2.low(), mOp2.high()                }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagM, word,     ({ 0xFC, mOp2.low(), mOp2.high()                }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagNC, word,    ({ 0xD4, mOp2.low(), mOp2.high()                }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagNZ, word,    ({ 0xC4, mOp2.low(), mOp2.high()                }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagP, word,     ({ 0xF4, mOp2.low(), mOp2.high()                }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagPE, word,    ({ 0xEC, mOp2.low(), mOp2.high()                }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagPO, word,    ({ 0xE4, mOp2.low(), mOp2.high()                }), TStates(17, 10));
Z80_OPCODE_2(CALL, flagZ, word,     ({ 0xCC, mOp2.low(), mOp2.high()                }), TStates(17, 10));
...
Z80_OPCODE_1(CP, byte,              ({ 0xFE, mOp1.value()                           }),  7);
Z80_OPCODE_1(CP, memHL,             ({ 0xBE                                         }),  7);
Z80_OPCODE_1(CP, IX_byte,           ({ 0xDD, 0xBE, mOp1.value()                     }), 19);
Z80_OPCODE_1(CP, IY_byte,           ({ 0xFD, 0xBE, mOp1.value()                     }), 19);
...
Z80_OPCODE_1(DEC, IX_byte,          ({ 0xDD, 0x35, mOp1.value()                     }), 23);
Z80_OPCODE_1(DEC, IY_byte,          ({ 0xFD, 0x35, mOp1.value()                     }), 23);
...
Z80_OPCODE_1(DJNZ, relOffset,       ({ 0x10, mOp1.value()                           }), TStates(8, 13));
...
Z80_OPCODE_1(IM, intMode,           ({ 0xED, mOp1.value()                           }),  8);
Z80_OPCODE_2(IN, A, portAddr,       ({ 0xDB, mOp2.value()                           }), 11);
...
Z80_OPCODE_1(INC, IX_byte,          ({ 0xDD, 0x34, mOp1.value()                     }), 23);
Z80_OPCODE_1(INC, IY_byte,          ({ 0xFD, 0x34, mOp1.value()                     }), 23);
...
Z80_OPCODE_1(JP, word,              ({ 0xC3, mOp1.low(), mOp1.high()                }), 10);
Z80_OPCODE_2(JP, flagC, word,       ({ 0xDA, mOp2.low(), mOp2.high()                }), 10);
Z80_OPCODE_2(JP, flagM, word,       ({ 0xFA, mOp2.low(), mOp2.high()                }), 10);
Z80_OPCODE_2(JP, flagNC, word,      ({ 0xD2, mOp2.low(), mOp2.high()                }), 10);
Z80_OPCODE_2(JP, flagNZ, word,      ({ 0xC2, mOp2.low(), mOp2.high()                }), 10);
Z80_OPCODE_2(JP, flagP, word,       ({ 0xF2, mOp2.low(), mOp2.high()                }), 10);
Z80_OPCODE_2(JP, flagPE, word,      ({ 0xEA, mOp2.low(), mOp2.high()                }), 10);
Z80_OPCODE_2(JP, flagPO, word,      ({ 0xE2, mOp2.low(), mOp2.high()                }), 10);
Z80_OPCODE_2(JP, flagZ, word,       ({ 0xCA, mOp2.low(), mOp2.high()                }), 10);
Z80_OPCODE_1(JP, memHL,             ({ 0xE9                                         }),  4);
Z80_OPCODE_1(JP, memIX,             ({ 0xDD, 0xE9                                   }),  8);
Z80_OPCODE_1(JP, memIY,             ({ 0xFD, 0xE9                                   }),  8);
Z80_OPCODE_1(JR, relOffset,         ({ 0x18, mOp1.value()                           }),  12);
Z80_OPCODE_2(JR, flagC, relOffset,  ({ 0x38, mOp1.value()                           }), TStates(12, 7));
Z80_OPCODE_2(JR, flagNC, relOffset, ({ 0x30, mOp1.value()                           }), TStates(12, 7));
Z80_OPCODE_2(JR, flagNZ, relOffset, ({ 0x20, mOp1.value()                           }), TStates(12, 7));
Z80_OPCODE_2(JR, flagZ, relOffset,  ({ 0x28, mOp1.value()                           }), TStates(12, 7));
...
Z80_OPCODE_2(LD, memHL, byte,       ({ 0x36, mOp1.value()                           }), 10);
Z80_OPCODE_2(LD, IX_byte, byte,     ({ 0xDD, 0x36, mOp1.value(), mOp2.value()       }), 19);
Z80_OPCODE_2(LD, IY_byte, byte,     ({ 0xFD, 0x36, mOp1.value(), mOp2.value()       }), 19);
Z80_OPCODE_2(LD, memAddr, A,        ({ 0x32, mOp1.low(), mOp1.high()                }), 13);
Z80_OPCODE_2(LD, memAddr, BC,       ({ 0xED, 0x43, mOp1.low(), mOp1.high()          }), 20);
Z80_OPCODE_2(LD, memAddr, DE,       ({ 0xED, 0x53, mOp1.low(), mOp1.high()          }), 20);
Z80_OPCODE_2(LD, memAddr, HL,       ({ 0x22, mOp1.low(), mOp1.high()                }), 16);
Z80_OPCODE_2(LD, memAddr, SP,       ({ 0xED, 0x73, mOp1.low(), mOp1.high()          }), 20);
Z80_OPCODE_2(LD, memAddr, IX,       ({ 0xDD, 0x22, mOp1.low(), mOp1.high()          }), 20);
Z80_OPCODE_2(LD, memAddr, IY,       ({ 0xFD, 0x22, mOp1.low(), mOp1.high()          }), 20);
Z80_OPCODE_2(LD, BC, word,          ({ 0x01, mOp1.low(), mOp1.high()                }), 10);
Z80_OPCODE_2(LD, DE, word,          ({ 0x11, mOp1.low(), mOp1.high()                }), 10);
Z80_OPCODE_2(LD, HL, word,          ({ 0x21, mOp1.low(), mOp1.high()                }), 10);
Z80_OPCODE_2(LD, SP, word,          ({ 0x31, mOp1.low(), mOp1.high()                }), 10);
Z80_OPCODE_2(LD, BC, memAddr,       ({ 0xED, 0x4B, mOp1.low(), mOp1.high()          }), 20);
Z80_OPCODE_2(LD, DE, memAddr,       ({ 0xED, 0x5B, mOp1.low(), mOp1.high()          }), 20);
Z80_OPCODE_2(LD, HL, memAddr,       ({ 0x2A, mOp1.low(), mOp1.high()                }), 16);
Z80_OPCODE_2(LD, SP, memAddr,       ({ 0xED, 0x7B, mOp1.low(), mOp1.high()          }), 20);
...
Z80_OPCODE_2(LD, IX_byte, A,        ({ 0xDD, 0x77, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IX_byte, B,        ({ 0xDD, 0x70, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IX_byte, C,        ({ 0xDD, 0x71, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IX_byte, D,        ({ 0xDD, 0x72, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IX_byte, E,        ({ 0xDD, 0x73, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IX_byte, H,        ({ 0xDD, 0x74, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IX_byte, L,        ({ 0xDD, 0x75, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IY_byte, A,        ({ 0xFD, 0x77, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IY_byte, B,        ({ 0xFD, 0x70, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IY_byte, C,        ({ 0xFD, 0x71, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IY_byte, D,        ({ 0xFD, 0x72, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IY_byte, E,        ({ 0xFD, 0x73, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IY_byte, H,        ({ 0xFD, 0x74, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, IY_byte, L,        ({ 0xFD, 0x75, mOp1.value()                     }), 19);
Z80_OPCODE_2(LD, I, A,              ({ 0xED, 0x47                                   }),  9);
Z80_OPCODE_2(LD, IX, word,          ({ 0xDD, 0x21, mOp2.low(), mOp2.high()          }), 14);
Z80_OPCODE_2(LD, IX, memAddr,       ({ 0xDD, 0x2A, mOp2.low(), mOp2.high()          }), 20);
Z80_OPCODE_2(LD, IY, word,          ({ 0xFD, 0x21, mOp2.low(), mOp2.high()          }), 14);
Z80_OPCODE_2(LD, IY, memAddr,       ({ 0xFD, 0x2A, mOp2.low(), mOp2.high()          }), 20);
...
Z80_OPCODE_2(LD, A, IX_byte,        ({ 0xDD, 0x7E, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, B, IX_byte,        ({ 0xDD, 0x46, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, C, IX_byte,        ({ 0xDD, 0x4E, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, D, IX_byte,        ({ 0xDD, 0x56, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, E, IX_byte,        ({ 0xDD, 0x5E, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, H, IX_byte,        ({ 0xDD, 0x66, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, L, IX_byte,        ({ 0xDD, 0x6E, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, A, IY_byte,        ({ 0xFD, 0x7E, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, B, IY_byte,        ({ 0xFD, 0x46, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, C, IY_byte,        ({ 0xFD, 0x4E, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, D, IY_byte,        ({ 0xFD, 0x56, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, E, IY_byte,        ({ 0xFD, 0x5E, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, H, IY_byte,        ({ 0xFD, 0x66, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, L, IY_byte,        ({ 0xFD, 0x6E, mOp2.value()                     }), 19);
Z80_OPCODE_2(LD, A, byte,           ({ 0x3E, mOp2.value()                           }),  7);
Z80_OPCODE_2(LD, B, byte,           ({ 0x06, mOp2.value()                           }),  7);
Z80_OPCODE_2(LD, C, byte,           ({ 0x0E, mOp2.value()                           }),  7);
Z80_OPCODE_2(LD, D, byte,           ({ 0x16, mOp2.value()                           }),  7);
Z80_OPCODE_2(LD, E, byte,           ({ 0x1E, mOp2.value()                           }),  7);
Z80_OPCODE_2(LD, H, byte,           ({ 0x26, mOp2.value()                           }),  7);
Z80_OPCODE_2(LD, L, byte,           ({ 0x2E, mOp2.value()                           }),  7);
Z80_OPCODE_2(LD, IXH, byte,         ({ 0xDD, 0x26, mOp2.value()                     }), 11);    // undocumented
Z80_OPCODE_2(LD, IYH, byte,         ({ 0xFD, 0x26, mOp2.value()                     }), 11);    // undocumented
Z80_OPCODE_2(LD, IXL, byte,         ({ 0xDD, 0x2E, mOp2.value()                     }), 11);    // undocumented
Z80_OPCODE_2(LD, IYL, byte,         ({ 0xFD, 0x2E, mOp2.value()                     }), 11);    // undocumented
...
Z80_OPCODE_1(OR, byte,              ({ 0xF6, mOp1.value()                           }),  7);
Z80_OPCODE_1(OR, memHL,             ({ 0xB6                                         }),  7);
Z80_OPCODE_1(OR, IX_byte,           ({ 0xDD, 0xB6, mOp1.value()                     }), 19);
Z80_OPCODE_1(OR, IY_byte,           ({ 0xFD, 0xB6, mOp1.value()                     }), 19);
...
Z80_OPCODE_2(OUT, portAddr, A,      ({ 0xD3, mOp1.value()                           }), 11);
...
Z80_OPCODE_2(RES, bit, A,           ({ 0xCB, mOp1.value(0x87)                       }),  8);
Z80_OPCODE_2(RES, bit, B,           ({ 0xCB, mOp1.value(0x80)                       }),  8);
Z80_OPCODE_2(RES, bit, C,           ({ 0xCB, mOp1.value(0x81)                       }),  8);
Z80_OPCODE_2(RES, bit, D,           ({ 0xCB, mOp1.value(0x82)                       }),  8);
Z80_OPCODE_2(RES, bit, E,           ({ 0xCB, mOp1.value(0x83)                       }),  8);
Z80_OPCODE_2(RES, bit, H,           ({ 0xCB, mOp1.value(0x84)                       }),  8);
Z80_OPCODE_2(RES, bit, L,           ({ 0xCB, mOp1.value(0x85)                       }),  8);
Z80_OPCODE_2(RES, bit, memHL,       ({ 0xCB, mOp1.value(0x86)                       }), 15);
Z80_OPCODE_2(RES, bit, IX_byte,     ({ 0xDD, 0xCB, mOp2.value(), mOp1.value(0x86)   }), 23);
Z80_OPCODE_2(RES, bit, IY_byte,     ({ 0xFD, 0xCB, mOp2.value(), mOp1.value(0x86)   }), 23);
...
Z80_OPCODE_1(RL, IX_byte,           ({ 0xDD, 0xCB, mOp1.value(), 0x16               }), 23);
Z80_OPCODE_1(RL, IY_byte,           ({ 0xFD, 0xCB, mOp1.value(), 0x16               }), 23);
...
Z80_OPCODE_1(RLC, IX_byte,          ({ 0xDD, 0xCB, mOp1.value(), 0x06               }), 23);
Z80_OPCODE_1(RLC, IY_byte,          ({ 0xFD, 0xCB, mOp1.value(), 0x06               }), 23);
...
Z80_OPCODE_1(RR, IX_byte,           ({ 0xDD, 0xCB, mOp1.value(), 0x1E               }), 23);
Z80_OPCODE_1(RR, IY_byte,           ({ 0xFD, 0xCB, mOp1.value(), 0x1E               }), 23);
...
Z80_OPCODE_1(RRC, IX_byte,          ({ 0xDD, 0xCB, mOp1.value(), 0x0E               }), 23);
Z80_OPCODE_1(RRC, IY_byte,          ({ 0xFD, 0xCB, mOp1.value(), 0x0E               }), 23);
Z80_OPCODE_0(RRCA,                  ({ 0x0F                                         }),  4);
Z80_OPCODE_0(RRD,                   ({ 0xED, 0x67                                   }), 18);
Z80_OPCODE_1(RST, rstIndex,         ({ mOp1.value(0xC7)                             }), 11);
...
Z80_OPCODE_2(SBC, A, byte,          ({ 0xDE, mOp2.value()                           }),  7);
Z80_OPCODE_2(SBC, A, memHL,         ({ 0x9E                                         }),  7);
Z80_OPCODE_2(SBC, A, IX_byte,       ({ 0xDD, 0x9E, mOp2.value()                     }), 19);
Z80_OPCODE_2(SBC, A, IY_byte,       ({ 0xFD, 0x9E, mOp2.value()                     }), 19);
...
Z80_OPCODE_2(SET, bit, A,           ({ 0xCB, mOp1.value(0xC7)                       }),  8);
Z80_OPCODE_2(SET, bit, B,           ({ 0xCB, mOp1.value(0xC0)                       }),  8);
Z80_OPCODE_2(SET, bit, C,           ({ 0xCB, mOp1.value(0xC1)                       }),  8);
Z80_OPCODE_2(SET, bit, D,           ({ 0xCB, mOp1.value(0xC2)                       }),  8);
Z80_OPCODE_2(SET, bit, E,           ({ 0xCB, mOp1.value(0xC3)                       }),  8);
Z80_OPCODE_2(SET, bit, H,           ({ 0xCB, mOp1.value(0xC4)                       }),  8);
Z80_OPCODE_2(SET, bit, L,           ({ 0xCB, mOp1.value(0xC5)                       }),  8);
Z80_OPCODE_2(SET, bit, memHL,       ({ 0xCB, mOp1.value(0xC6)                       }), 15);
Z80_OPCODE_2(SET, bit, IX_byte,     ({ 0xDD, 0xCB, mOp2.value(), mOp1.value(0xC6)   }), 23);
Z80_OPCODE_2(SET, bit, IY_byte,     ({ 0xFD, 0xCB, mOp2.value(), mOp1.value(0xC6)   }), 23);
...
Z80_OPCODE_1(SLA, IX_byte,          ({ 0xDD, 0xCB, mOp1.value(), 0x26               }), 23);
Z80_OPCODE_1(SLA, IY_byte,          ({ 0xFD, 0xCB, mOp1.value(), 0x26               }), 23);
...
Z80_OPCODE_1(SLL, IX_byte,          ({ 0xDD, 0xCB, mOp1.value(), 0x36               }), 23);    // undocumented
Z80_OPCODE_1(SLL, IY_byte,          ({ 0xFD, 0xCB, mOp1.value(), 0x36               }), 23);    // undocumented
...
Z80_OPCODE_1(SRA, IX_byte,          ({ 0xDD, 0xCB, mOp1.value(), 0x2E               }), 23);
Z80_OPCODE_1(SRA, IY_byte,          ({ 0xFD, 0xCB, mOp1.value(), 0x2E               }), 23);
...
Z80_OPCODE_1(SRL, IX_byte,          ({ 0xDD, 0xCB, mOp1.value(), 0x3E               }), 23);
Z80_OPCODE_1(SRL, IY_byte,          ({ 0xFD, 0xCB, mOp1.value(), 0x3E               }), 23);
...
Z80_OPCODE_1(SUB, byte,             ({ 0xD6, mOp1.value()                           }),  7);
...
Z80_OPCODE_1(SUB, IX_byte,          ({ 0xDD, 0x96, mOp1.value()                     }), 19);
Z80_OPCODE_1(SUB, IY_byte,          ({ 0xFD, 0x96, mOp1.value()                     }), 19);
...
Z80_OPCODE_1(XOR, byte,             ({ 0xEE, mOp1.value()                           }),  7);
Z80_OPCODE_1(XOR, memHL,            ({ 0xAE                                         }),  7);
Z80_OPCODE_1(XOR, IX_byte,          ({ 0xDD, 0xAE, mOp1.value()                     }), 19);
Z80_OPCODE_1(XOR, IY_byte,          ({ 0xFD, 0xAE, mOp1.value()                     }), 19);
